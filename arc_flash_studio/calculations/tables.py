...
TABLE_1_ARCING_CURRENT: Dict[ElectrodeConfig, Dict[int, Dict[str, float]]] = {
    ...
    ElectrodeConfig.HCB: {
        ...
        2700: {
            ...
            "k7": -1.814e-7, "k8": -9.218e-6, "k9": -0.0007, "k10": 0.9881
        },
        14300: {
            "k1": 0.008693, "k2": 0.999, "k3": -0.02,
            "k4": 0, "k5": 0, "k6": 2.233e-8,
            "k7": -3.946e-6, "k8": 0.000116, "k9": -0.00145, "k10": 0.9839
        },
    },
    ElectrodeConfig.VOA: {
        600: {
            "k1": 0.043785, "k2": 1.04, "k3": -0.18,
            "k4": 0, "k5": -5.043e-11, "k6": -4.783e-9,
            "k7": 1.962e-6, "k8": -0.000229, "k9": 0.003141, "k10": 1.092
        },
        2700: {
